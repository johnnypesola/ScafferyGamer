class Category_485 {
	...
	class M4A1_HWS_GL { //GL Holo Green
		type = "trade_weapons";
		buy[] = {8,"ItemGoldBar"};
		sell[] = {4,"ItemGoldBar"};
	};
	class BAF_L85A2_UGL_Holo { //GL Holo
		type = "trade_weapons";
		buy[] = {8,"ItemGoldBar"};
		sell[] = {4,"ItemGoldBar"};
	};
	class M4A3_RCO_GL_EP1 { //RCO GL
		type = "trade_weapons";
		buy[] = {8,"ItemGoldBar"};
		sell[] = {4,"ItemGoldBar"};
	};
	class AKS_74_kobra { // AK 74 Kobra
		type = "trade_weapons";
		buy[] = {4,"ItemGoldBar"};
		sell[] = {2,"ItemGoldBar"};
	};
	class AK74_Kobra_DZ { // AK 74 Kobra
		type = "trade_weapons";
		buy[] = {4,"ItemGoldBar"};
		sell[] = {2,"ItemGoldBar"};
	};
	class M16A2_GL_DZ { // Sell only
		type = "trade_weapons";
		buy[] = {-1,"ItemGoldBar"};
		sell[] = {4,"ItemGoldBar"};
	};
	class M16A4_ACOG_DZ { // M16 ACOG
		type = "trade_weapons";
		buy[] = {-1,"ItemGoldBar"};
		sell[] = {6,"ItemGoldBar"};
	};
	class Sa58V_EP1 { // sell only
		type = "trade_weapons";
		buy[] = {-1,"ItemGoldBar"};
		sell[] = {2,"ItemGoldBar"};
	};
	class M4A1_CCO_DZ { // sell only
		type = "trade_weapons";
		buy[] = {-1,"ItemGoldBar"};
		sell[] = {4,"ItemGoldBar"};
	};
	class G36_C_SD_Eotech { // sell only
		type = "trade_weapons";
		buy[] = {-1,"ItemGoldBar"};
		sell[] = {6,"ItemGoldBar"};
	};
	class AKS_74_U { // sell only
		type = "trade_weapons";
		buy[] = {-1,"ItemGoldBar"};
		sell[] = {1,"ItemGoldBar"};
	};
	class AKS_74_UN_Kobra { // sell only
		type = "trade_weapons";
		buy[] = {-1,"ItemGoldBar"};
		sell[] = {2,"ItemGoldBar"};
	};
