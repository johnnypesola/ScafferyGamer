...
// Aircraft Dealer
menu_Drake_Light = [
	[["Airplanes",517],["Helicopter Unarmed",519],["Airport Utility",717]],
	[],
	"neutral"
];
// Vehicles Neutral
...
// Hero Building/Parts
//menu_INS_Worker2_DZ = [
//	[["Metal and Concrete Supplies",693]],
//	[["CinderBlocks","ItemGoldBar",10,1,"buy","Gold Bar 10oz","x Cinder Blocks",101],
//	["MortarBucket","ItemGoldBar",10,1,"buy","Gold Bar 10oz","x Mortar Buckets",101]],
//	"hero"
//];
// Bandit Building/Parts
menu_INS_Lopotev_DZ = [
	[["Metal and Concrete Supplies",700]],
	[["CinderBlocks","ItemGoldBar",10,1,"buy","Gold Bar 1oz","x Cinder Blocks",101],
	["MortarBucket","ItemGoldBar",10,1,"buy","Gold Bar 1oz","x Mortar Buckets",101]],
	"hostile"
];
// Calling's Captive Trader Construction/Parts
menu_INS_Worker2_DZ = [
	[["Metal and Concrete Supplies",693]],
	[["CinderBlocks","ItemGoldBar",10,1,"buy","Gold Bar 1oz","x Cinder Blocks",101],
	["MortarBucket","ItemGoldBar",10,1,"buy","Gold Bar 1oz","x Mortar Buckets",101]],
...
// Super Hero Trader
menu_INS_Soldier_CO_DZ = [
	[["Heavy Armored",694],["Special Helicopter",696],["Anti Air Weapons",703],["Anti Tank Weapons",701],["Anti Air Ammo",713],["Anti Tank Ammo",715],["General Ammo", 718]],
	[],
	"superhero"
];
// Super Villain Trader
menu_GUE_Woodlander1 = [
	[["Heavy Armored",695],["Special Helicopter",697],["Anti Air Weapons",704],["Anti Tank Weapons",702],["Anti Air Ammo",714],["Anti Tank Ammo",716],["General Ammo", 719]],
	[],
	"superhostile"
];
