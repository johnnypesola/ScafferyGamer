...
DROP EVENT IF EXISTS createMissionFromOldBases;
DELIMITER ;;
CREATE EVENT createMissionFromOldBases ON SCHEDULE EVERY 1 DAY STARTS '2017-04-22 00:00:00' COMMENT 'Removes old objects and creates missions from them' DO
BEGIN
        -- -----------------------------------
        --             Chernarus
        -- -----------------------------------
