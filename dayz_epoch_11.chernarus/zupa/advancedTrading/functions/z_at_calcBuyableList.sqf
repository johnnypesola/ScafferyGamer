			...
			for "_i" from 0 to (count _cfgtraders) - 1 do
			{
				...
				if (isClass _y) then
				{
					...
					if(!Z_SingleCurrency) then {
						...
						if (!isNumber ((_part >> "worth"))) then {
							switch (_part) do {
								case "ItemRuby":{_worth = 100000000;};
								case "ItemEmerald":{_worth = 10000000;};
								case "ItemSapphire":{_worth = 1000000;};
								case "ItemTopaz":{_worth = 100000;};
							};
						};
					} else {
