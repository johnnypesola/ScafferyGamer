...
if ((getPlayerUID player) in AdminList) then { // Admins
	diag_log format ["You (%1) have now access to the admin tools menu.", (name player)];
	epochmenustart = [
	["",true],
...
["",true],
	...
	["Point to Show Info",[],"", -5,[["expression",format[_EXECscript1,"PointToGetInfo.sqf"]]],"1","1"],
...
CrateMenuLocal=[
	...
	["Base Kit Crate",[],"",-5,[["expression",format[_EXECscript6,"basekit.sqf"]]],"1","1"],
	["War Crate",[],"",-5,[["expression",format[_EXECscript6,"warkit.sqf"]]],"1","1"],
...
["BaseDestruction",true],
	...
	["DESTROY PlotPole Inside Dome",[],"",-5,[["expression",'["destroyplot"] execVM "admintools\tools\deletebase.sqf"']],"1","1"],
		["", [], "", -5, [["expression", ""]], "1", "0"],
		["Main Menu", [20], "#USER:epochmenustart", -5, [["expression", ""]], "1", "1"]
];
VehicleTempMenu=
