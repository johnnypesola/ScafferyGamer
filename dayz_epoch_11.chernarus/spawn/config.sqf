...
class_public = [ // These are visible to anyone on the server
	...
	[(localize "str_playerstats_bandit")+" Lvl4","Bandit1_DZ","BanditW1_DZ",[START_ITEMS2,"17Rnd_9x19_glock17",3,"ItemMorphine"],["G17_DZ","ItemToolbox","ItemMap"],"DZ_TK_Assault_Pack_EP1",[],["ItemToolbox","ItemMap","ItemHatchet","ItemRadio"],0,-100000,-1,""],
	...
	[(localize "str_playerstats_hero")+" Lvl7",if (class_epoch) then {"Rocket_DZ"} else {"Survivor3_DZ"},"SurvivorWcombat_DZ",[START_ITEMS5,"15Rnd_9x19_M9SD",4,"ItemMorphine","20Rnd_762x51_FNFAL",2],["FNFAL_DZ","M9_SD_DZ","ItemToolbox","ItemMap","ItemHatchet","ItemRadio","ItemCrowbar","Binocular"],"DZ_GunBag_EP1",[],[],0,900000,-1,""],
