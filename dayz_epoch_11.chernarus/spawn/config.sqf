...
class_public = [ // These are visible to anyone on the server
	...
	[(localize "str_playerstats_bandit")+" Lvl2","Bandit1_DZ","BanditW1_DZ",[START_ITEMS1,"17Rnd_9x19_glock17",1],["G17_DZ","ItemMap"],"DZ_Assault_Pack_EP1",[],[],0,-10000,-1,""],
	[(localize "str_playerstats_bandit")+" Lvl3","Bandit1_DZ","BanditW1_DZ",[START_ITEMS1,"17Rnd_9x19_glock17",2,"ItemMorphine"],["G17_DZ","ItemMap"],"DZ_TK_Assault_Pack_EP1",[],[],0,-25000,-1,""],
	[(localize "str_playerstats_bandit")+" Lvl4","Bandit1_DZ","BanditW1_DZ",[START_ITEMS2,"17Rnd_9x19_glock17",3,"ItemMorphine"],["G17_DZ","ItemMap","ItemHatchet"],"DZ_TK_Assault_Pack_EP1",[],[],0,-50000,-1,""],
	[(localize "str_playerstats_bandit")+" Lvl5","GUE_Commander_DZ","BanditW2_DZ",[START_ITEMS3,"17Rnd_9x19_glock17",4,"ItemMorphine","10Rnd_303British"],["LeeEnfield_DZ","G17_DZ","ItemMap","ItemHatchet"],"DZ_TK_Assault_Pack_EP1",[],[],0,-75000,-1,""],
	[(localize "str_playerstats_bandit")+" Lvl6","GUE_Commander_DZ","BanditW2_DZ",[START_ITEMS4,"17Rnd_9x19_glock17",4,"ItemMorphine","10Rnd_303British",2],["LeeEnfield_DZ","G17_DZ","ItemMap","ItemHatchet"],"DZ_ALICE_Pack_EP1",[],[],0,-125000,-1,""],
	[(localize "str_playerstats_bandit")+" Lvl7","GUE_Commander_DZ","BanditW2_DZ",[START_ITEMS5,"17Rnd_9x19_glock17",4,"ItemMorphine","10Rnd_303British",2],["LeeEnfield_DZ","G17_DZ","ItemMap","ItemHatchet","ItemToolbox"],"DZ_British_ACU",[],[],0,-200000,-1,""],
	...
	[(localize "str_playerstats_hero")+" Lvl2",if (class_epoch) then {"Soldier_Sniper_PMC_DZ"} else {"Survivor3_DZ"},"SurvivorW2_DZ",[START_ITEMS1,"6Rnd_45ACP",1],["Revolver_DZ","ItemMap"],"DZ_Assault_Pack_EP1",[],[],0,10000,-1,""],
	[(localize "str_playerstats_hero")+" Lvl3",if (class_epoch) then {"Soldier_Sniper_PMC_DZ"} else {"Survivor3_DZ"},"SurvivorW2_DZ",[START_ITEMS1,"6Rnd_45ACP",2,"ItemMorphine"],["Revolver_DZ","ItemMap"],"DZ_TK_Assault_Pack_EP1",[],[],0,25000,-1,""],
	[(localize "str_playerstats_hero")+" Lvl4",if (class_epoch) then {"Soldier_Sniper_PMC_DZ"} else {"Survivor3_DZ"},"SurvivorW2_DZ",[START_ITEMS2,"6Rnd_45ACP",3,"ItemMorphine"],["Revolver_DZ","ItemMap","ItemHatchet"],"DZ_TK_Assault_Pack_EP1",[],[],0,50000,-1,""],
	[(localize "str_playerstats_hero")+" Lvl5",if (class_epoch) then {"Soldier1_DZ"} else {"Survivor3_DZ"},"SurvivorWurban_DZ",[START_ITEMS3,"6Rnd_45ACP",4,"ItemMorphine","10Rnd_303British"],["LeeEnfield_DZ","Revolver_DZ","ItemMap","ItemHatchet"],"DZ_TK_Assault_Pack_EP1",[],[],0,75000,-1,""],
	[(localize "str_playerstats_hero")+" Lvl6",if (class_epoch) then {"Soldier1_DZ"} else {"Survivor3_DZ"},"SurvivorWcombat_DZ",[START_ITEMS4,"15Rnd_9x19_M9SD",2,"ItemMorphine","20Rnd_762x51_FNFAL",2],["FNFAL_DZ","M9_SD_DZ","ItemMap","ItemHatchet","ItemCrowbar","Binocular"],"DZ_GunBag_EP1",[],[],0,125000,-1,""],
