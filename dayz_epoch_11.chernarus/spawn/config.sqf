...
class_public = [ // These are visible to anyone on the server
	...
	[(localize "str_playerstats_hero")+" Lvl6",if (class_epoch) then {"Soldier1_DZ"} else {"Survivor3_DZ"},"SurvivorWcombat_DZ",[START_ITEMS4,"15Rnd_9x19_M9SD",2,"ItemMorphine","20Rnd_762x51_FNFAL",2],["FNFAL_DZ","M9_SD_DZ","ItemToolbox","ItemMap","ItemHatchet","ItemRadio","ItemCrowbar","Binocular"],"DZ_GunBag_EP1",[],[],0,400000,-1,""],
	[(localize "str_playerstats_hero")+" Lvl7",if (class_epoch) then {"Rocket_DZ"} else {"Survivor3_DZ"},"SurvivorWcombat_DZ",[START_ITEMS5,"15Rnd_9x19_M9SD",4,"ItemMorphine","5Rnd_762x51_M24",4],["M40A3","M9_SD_DZ","ItemToolbox","ItemMap","ItemHatchet","ItemRadio","ItemCrowbar","Binocular_Vector"],"DZ_GunBag_EP1",[],[],0,800000,-1,""],
