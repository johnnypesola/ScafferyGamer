...
#define START_ITEMS1 "HandRoadFlare","ItemBandage",1
#define START_ITEMS2 "HandRoadFlare","ItemBandage",1,"ItemPainkiller"
#define START_ITEMS3 "HandRoadFlare","ItemBandage",2,"ItemPainkiller"
...
#define START_ITEMS6 "HandRoadFlare","ItemBandage",4,"ItemPainkiller"

local _skins = ["BAF_Soldier_Officer_MTP_DZ","Firefighter_Officer2_DZ", "Civilian13_DZ", "TK_CIV_Takistani03_EP1_DZ","SurvivorWpink_DZ","BusinessMan_DZ","pz_suit1","Rocker2_DZ","Worker1_DZ"];

class_public = [ // These are visible to anyone on the server
	[(localize "str_playerstats_bandit")+" Lvl1","Bandit1_DZ","BanditW1_DZ",[START_ITEMS1],["ItemMap"],"",[],[],0,-5000,-1,""],
	[(localize "str_playerstats_bandit")+" Lvl2","Bandit1_DZ","BanditW1_DZ",[START_ITEMS1,"17Rnd_9x19_glock17",1],["G17_DZ","ItemToolbox","ItemMap"],"DZ_Assault_Pack_EP1",[],[],0,-10000,-1,""],
	[(localize "str_playerstats_bandit")+" Lvl3","Bandit1_DZ","BanditW1_DZ",[START_ITEMS1,"17Rnd_9x19_glock17",2,"ItemMorphine"],["G17_DZ","ItemToolbox","ItemMap"],"DZ_TK_Assault_Pack_EP1",[],[],0,-25000,-1,""],
	[(localize "str_playerstats_bandit")+" Lvl4","Bandit1_DZ","BanditW1_DZ",[START_ITEMS2,"17Rnd_9x19_glock17",3,"ItemMorphine"],["G17_DZ","ItemToolbox","ItemMap","ItemHatchet"],"DZ_TK_Assault_Pack_EP1",[],[],0,-50000,-1,""],
	[(localize "str_playerstats_bandit")+" Lvl5","GUE_Commander_DZ","BanditW2_DZ",[START_ITEMS3,"17Rnd_9x19_glock17",4,"ItemMorphine","10Rnd_303British"],["LeeEnfield_DZ","G17_DZ","ItemToolbox","ItemMap","ItemHatchet"],"DZ_TK_Assault_Pack_EP1",[],[],0,-75000,-1,""],
	[(localize "str_playerstats_bandit")+" Lvl6","GUE_Commander_DZ","BanditW2_DZ",[START_ITEMS4,"17Rnd_9x19_glock17",4,"ItemMorphine","10Rnd_303British",2],["LeeEnfield_DZ","G17_DZ","ItemToolbox","ItemMap","ItemHatchet"],"DZ_ALICE_Pack_EP1",[],[],0,-125000,-1,""],
	[(localize "str_playerstats_bandit")+" Lvl7","GUE_Commander_DZ","BanditW2_DZ",[START_ITEMS5,"17Rnd_9x19_glock17",4,"ItemMorphine","10Rnd_303British",2],["LeeEnfield_DZ","G17_DZ","ItemToolbox","ItemMap","ItemHatchet"],"DZ_British_ACU",[],[],0,-200000,-1,""],
	[(localize "str_playerstats_hero")+" Lvl1",if (class_epoch) then {"Soldier_Sniper_PMC_DZ"} else {"Survivor3_DZ"},"SurvivorW2_DZ",[START_ITEMS1],["ItemMap"],"",[],[],0,5000,-1,""],
	[(localize "str_playerstats_hero")+" Lvl2",if (class_epoch) then {"Soldier_Sniper_PMC_DZ"} else {"Survivor3_DZ"},"SurvivorW2_DZ",[START_ITEMS1,"6Rnd_45ACP",1],["Revolver_DZ","ItemToolbox","ItemMap"],"DZ_Assault_Pack_EP1",[],[],0,10000,-1,""],
	[(localize "str_playerstats_hero")+" Lvl3",if (class_epoch) then {"Soldier_Sniper_PMC_DZ"} else {"Survivor3_DZ"},"SurvivorW2_DZ",[START_ITEMS1,"6Rnd_45ACP",2,"ItemMorphine"],["Revolver_DZ","ItemToolbox","ItemMap"],"DZ_TK_Assault_Pack_EP1",[],[],0,25000,-1,""],
	[(localize "str_playerstats_hero")+" Lvl4",if (class_epoch) then {"Soldier_Sniper_PMC_DZ"} else {"Survivor3_DZ"},"SurvivorW2_DZ",[START_ITEMS2,"6Rnd_45ACP",3,"ItemMorphine"],["Revolver_DZ","ItemToolbox","ItemMap","ItemHatchet"],"DZ_TK_Assault_Pack_EP1",[],[],0,50000,-1,""],
	[(localize "str_playerstats_hero")+" Lvl5",if (class_epoch) then {"Soldier1_DZ"} else {"Survivor3_DZ"},"SurvivorWurban_DZ",[START_ITEMS3,"6Rnd_45ACP",4,"ItemMorphine","10Rnd_303British"],["LeeEnfield_DZ","Revolver_DZ","ItemToolbox","ItemMap","ItemHatchet"],"DZ_TK_Assault_Pack_EP1",[],[],0,75000,-1,""],
	[(localize "str_playerstats_hero")+" Lvl6",if (class_epoch) then {"Soldier1_DZ"} else {"Survivor3_DZ"},"SurvivorWcombat_DZ",[START_ITEMS4,"15Rnd_9x19_M9SD",2,"ItemMorphine","20Rnd_762x51_FNFAL",2],["FNFAL_DZ","M9_SD_DZ","ItemToolbox","ItemMap","ItemHatchet","ItemCrowbar","Binocular"],"DZ_GunBag_EP1",[],[],0,125000,-1,""],
	[(localize "str_playerstats_hero")+" Lvl7",if (class_epoch) then {"Rocket_DZ"} else {"Survivor3_DZ"},"SurvivorWcombat_DZ",[START_ITEMS5,"15Rnd_9x19_M9SD",4,"ItemMorphine","5Rnd_762x51_M24",4],["M40A3","M9_SD_DZ","ItemToolbox","ItemMap","ItemHatchet","ItemCrowbar","Binocular_Vector"],"DZ_GunBag_EP1",[],[],0,200000,-1,""],
	...
	["Prisoner "+(localize "str_playerstats_survivor"),["Prisoner1_DZ","Prisoner2_DZ"] call BIS_fnc_selectRandom, ["Prisoner2_DZ","Prisoner3_DZ"] call BIS_fnc_selectRandom, [START_ITEMS1,"ItemTent"],["ItemCrowbar"],"",[],[],0,0,0],
	...
	["Firefighter"+(localize "str_playerstats_survivor"),["Firefighter1_DZ","Firefighter2_DZ","Firefighter3_DZ","Firefighter_Officer1_DZ"] call BIS_fnc_selectRandom,["Firefighter4_DZ","Firefighter5_DZ","Firefighter_Officer2_DZ"] call BIS_fnc_selectRandom,[START_ITEMS5,"ItemMorphine"],["ItemHatchet"],"",[],[],0,0,0],
	["Policeman"+(localize "str_playerstats_survivor"),"RU_Policeman_DZ","RU_Policeman2_DZ",[START_ITEMS5,"ItemMorphine"],["M1014_DZ","Cuffs_DZE"],"",[],[],0,0,0],
