...
serverTraders = ["RU_Functionary1","RU_Citizen3","Rocker4","Profiteer4","Rita_Ensler_EP1","CIV_EuroMan01_EP1","CIV_EuroMan02_EP1","TK_GUE_Soldier_5_EP1","GUE_Soldier_MG","Worker2","Worker3","Woodlander1","UN_CDF_Soldier_Pilot_EP1","RU_WorkWoman1","Dr_Annie_Baker_EP1","RU_Citizen4","RU_WorkWoman5","RU_Citizen1","RU_Villager3","TK_CIV_Takistani04_EP1","Pilot_EP1","RU_Profiteer4","Woodlander3","Dr_Hladik_EP1","Doctor","HouseWife1","GUE_Woodlander2","Soldier_M4A3_PMC","Soldier_PMC", "Soldier_AA_PMC"];
...
menu_Soldier_M4A3_PMC = [
	[["Metal and Concrete Supplies",698]],
...
// Super hero trader
menu_Soldier_PMC = [
	[["Heavy Armored",695],["Special Helicopter",697],["Anti Air Weapons",705],["Anti Tank Weapons",703],["Anti Air Ammo",715],["Anti Tank Ammo",717],["General Ammo", 719]],
	[],
	"superhero"
];
...
// Super bandit trader
menu_Soldier_AA_PMC = [
	[["Heavy Armored",694],["Special Helicopter",696],["Anti Air Weapons",704],["Anti Tank Weapons",702],["Anti Air Ammo",714],["Anti Tank Ammo",716],["General Ammo", 718]],
	[],
	"superhostile"
];
