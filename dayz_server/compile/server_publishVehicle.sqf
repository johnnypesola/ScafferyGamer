...
_key = [dayZ_instance, _class, _damage , _characterID, format["'%1'", [_worldspace select 0, _worldspace select 1] call AN_fnc_formatWorldspace], "'[]'", format["'%1'", _array], _fuel,_uid];
