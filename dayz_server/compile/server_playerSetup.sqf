...
//PVCDZ_plr_Login2 = [_worldspace,_state,_randomSpot,(_lastInstance!=dayZ_instance)];

// ESS v3 and FERRY
PVCDZ_plr_Login2 = [[0,respawn_west_original],_state,_worldspace,_randomSpot,([_randomSpot,_playerID] call spawn_config), _lastInstance!=dayZ_instance];
