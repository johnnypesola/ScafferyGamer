...
private ["_characterID","_minutes","_newObject","_playerID","_playerName","_key","_query","_pos","_infected","_sourceName","_sourceWeapon","_distance","_message","_method","_suicide","_bodyName","_type"];
...
_newObject setVariable ["bodyUID",_playerID,true];	// ESS v3
...
if (_characterID != "0") then {
	_key = [_characterID,_minutes,_infected];
	_query = ["playerDeath", _key] call dayz_prepareDataForDB;
