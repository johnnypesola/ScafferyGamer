private ["_key","_query","_baseList","_base","_baseId","_baseParts","_ws_x","_ws_y","_ws_z","_numberOfBaseParts","_qty","_obj","_page","_pageSize","_objId","_DZE_VehObjects","_vehEhSetter","_uniqId","_dataStatus","_accessResult","_numFields","_numRows","_columnNames","_foundSafePos","_tries"];
