private ["_keyItem","_claimingPlayerUID","_claimingPlayer","_missionParams","_missionInsurance","_checkStartTime","_checkTime","_timeout"];
...
_checkTime =  _checkStartTime - diag_tickTime;
_timeout = false;
