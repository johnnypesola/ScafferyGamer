private ["_isInfected","_doLoop","_hiveVer","_isHiveOk","_playerID","_playerObj","_primary","_key","_query","_charID","_playerName","_backpack","_isNew","_inventory","_survival","_model","_mags","_wpns","_bcpk","_config","_newPlayer","_result","_humanity","_generation","_ws"];
...
if ((isNil "_primary") || (count _primary == 0)) exitWith {
#ifdef DZE_SERVER_DEBUG
