...
OKAISpawn = "\z\addons\dayz_server\OK\Scripts\OKAISpawn.sqf";
OKAISpawn2 = "\z\addons\dayz_server\OK\Scripts\OKAISpawn2.sqf";
...
OKFindPos = {
	...
	else
	{
		...
		while {_findRun} do {
			...
			_pos = [getMarkerPos "center",0,10200,50,0,1000,0] call BIS_fnc_findSafePos;
