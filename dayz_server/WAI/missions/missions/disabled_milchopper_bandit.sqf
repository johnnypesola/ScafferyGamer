...
diag_log format["WAI: Mission Armed Soldier Chopper Started At %1",_position];
...
diag_log format["WAI: Mission Armed Soldier Chopper spawned a %1",_vehname];
...
[nil,nil,rTitleText,"Soldiers are guarding a disabled armed chopper! Check your map for the location!", "PLAIN",10] call RE;
