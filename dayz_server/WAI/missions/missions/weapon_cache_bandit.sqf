...
[_position,"Weapon cache"] execVM "\z\addons\dayz_server\WAI\missions\compile\banditmarkers.sqf";
[nil,nil,rTitleText,"Soldiers are guarding a weapon crate! Check your map for the location!", "PLAIN",10] call RE;
