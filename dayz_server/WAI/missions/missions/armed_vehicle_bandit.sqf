...
diag_log format["WAI: Mission Armed Soldier Vehicle Started At %1",_position];
...
diag_log format["WAI: Mission Armed Soldier Vehicle spawned a %1",_vehname];
...
[_position,_vehname] execVM "\z\addons\dayz_server\WAI\missions\compile\banditmarkers.sqf";
[nil,nil,rTitleText,"Soldiers obtained an armed vehicle! Check your map for the location!", "PLAIN",10] call RE;
...
if (_playerPresent) then {
	...
	diag_log format["WAI: Mission Armed Soldier vehicle Ended At %1",_position];
