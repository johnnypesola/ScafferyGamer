...
[nil,nil,rTitleText,"Soldiers are guarding a disabled Civilian Aircraft! Check your map for the location!", "PLAIN",10] call RE;
...
if (_playerPresent) then {
	...
	waitUntil
	{
		sleep 5;
		_playerPresent = false;
		{if((isPlayer _x) AND (_x distance _position <= 30)) then {_playerPresent = true; /*[_x, "banditmissionclean"] call attack_intruder;*/};}forEach playableUnits;
		(_playerPresent)
	};
